...
//   return (
//     <div className="w-full h-screen bg-black text-white flex flex-col items-center justify-between">
//       <h1 className="text-7xl text-white font-bold font-['Saira_Stencil_One'] underline mt-20">Contact Me</h1>
//       <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
//         {contactInfo.map((item, idx) => (
//           <div key={idx} className="flex flex-col items-center space-y-4">
//             <div className="w-20 h-20 rounded-full bg-zinc-900 flex items-center justify-center shadow-md">
//               {item.icon}
//             </div>
...
//         ))}
//       </div>
//       <footer className="p-5 flex flex-row items-center justify-around bg-[#232323] w-full rounded-t-3xl ">
...
//         </p>
//         <p className="text-sm text-gray-400">
//          ❤️ Designed and Developed by Payal Gupta
//         </p>
//       </footer>
//     </div>
//   );
...
const ContactSection = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white flex flex-col items-center px-4 py-10">
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold font-['Saira_Stencil_One'] underline text-center mb-10">
        Contact Me
      </h1>
      ...
      <footer className="mt-16 w-full bg-[#232323] py-5 px-4 rounded-t-3xl flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-2 text-center">
